package fhi360.covid.exception;

import fhi360.covid.payload.response.ApiResponse;
import fhi360.covid.payload.response.ExceptionResponse;
...
public class RestControllerExceptionHandler {
    ...
    public ResponseEntity<ApiResponse> resolveException(CovidException exception) {
